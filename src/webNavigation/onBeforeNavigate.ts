 ...
 */
export function onBeforeNavigate<T extends AllowedListener>({ filter }: { filter?: (details: browser.WebNavigation.OnBeforeNavigateDetailsType) => boolean | Promise<boolean> } = {}) {
