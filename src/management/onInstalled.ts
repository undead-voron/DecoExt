...
const extensionInfoDecoratorInfo = createDecorator<keyof browser.Management.ExtensionInfo | void>('extensionInfo')

export const extensionInfo = extensionInfoDecoratorInfo.decorator

// map onInstalled data to parameter decorators
